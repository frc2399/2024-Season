...
public class RobotContainer {
        ...
        private void configureButtonBindingsDriver() {
                ...
                driverController.leftBumper().whileTrue(indexer.setIndexerPID(-0.3));
                ...
                driverController.rightBumper().whileTrue(intake.setIntakePID(-0.3));
