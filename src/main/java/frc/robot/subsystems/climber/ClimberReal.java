...
public class ClimberReal implements ClimberIO {
    ...
    public void periodicUpdate() {
        ...
        SmartDashboard.putNumber("climber/left/height (m)", getLeftEncoderPosition());
        SmartDashboard.putNumber("climber/left/current (A)", leftMotorController.getOutputCurrent());
        SmartDashboard.putNumber("climber/left/velocity (m per s)", leftMotorController.getAppliedOutput());
        SmartDashboard.putBoolean("climber/left/is retracted", isLeftRetracted());
        SmartDashboard.putBoolean("climber/left/is extended", isLeftExtended());
        SmartDashboard.putBoolean("climber/left/is stalling", isLeftSideStalling());

        SmartDashboard.putNumber("climber/right/height (m)", getRightEncoderPosition());
        SmartDashboard.putNumber("climber/right/current (A)", rightMotorController.getOutputCurrent());
        SmartDashboard.putNumber("climber/right/velocity (m per s)", rightMotorController.getAppliedOutput());
        SmartDashboard.putBoolean("climber/right/is retracted", isRightRetracted());
        SmartDashboard.putBoolean("climber/right/is extended", isRightExtended());
        SmartDashboard.putBoolean("climber/right/is stalling", isRightSideStalling());
